...
type Instance struct {
	...
	PhpCertID     *int64     `gorm:"column:php_cert_id" json:"php_cert_id"`
	Domain        string     `gorm:"column:domain;size:255;not null" json:"domain"`
	ProductType   string     `gorm:"column:product_type;default:cloud_push" json:"product_type"`
	Edition       string     `gorm:"column:edition;default:free" json:"edition"`
	EditionName   string     `gorm:"column:edition_name;size:50" json:"edition_name"`
	...
	AutoRenew     int8       `gorm:"column:auto_renew;default:0" json:"auto_renew"`
