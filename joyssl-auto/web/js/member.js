$(".nameclick").click(function(){
	...
	$('.xgname .tanbiaodan .modifymemberlayer .memberlayer1').animate({left:"0%"},100);
	$('.xgname .tanbiaodan .modifymemberlayer .memberlayer2').animate({left:"100%"},100);
...
$(".mmclick").click(function(){
		...
		$('.dlmm .tanbiaodan .modifymemberlayer .memberlayer1').animate({left:"0%"},100);
		$('.dlmm .tanbiaodan .modifymemberlayer .memberlayer2').animate({left:"100%"},100);
...
$(".yxclick").click(function(){
		...
		$('.dlyx .tanbiaodan .modifymemberlayer .memberlayer1').animate({left:"0%"},100);
		$('.dlyx .tanbiaodan .modifymemberlayer .memberlayer2').animate({left:"100%"},100);
	...
	$(".sjclick").click(function(){
		...
		$('.sjbd .tanbiaodan .modifymemberlayer .memberlayer1').animate({left:"0%"},100);
		$('.sjbd .tanbiaodan .modifymemberlayer .memberlayer2').animate({left:"100%"},100);
...
$(".wxclick").click(function(){
	...
	$('.wxdl .tanbiaodan .modifymemberlayer .memberlayer1').animate({left:"0%"},100);
	$('.wxdl .tanbiaodan .modifymemberlayer .memberlayer2').animate({left:"100%"},100);
...
$(".iplick").click(function(){
	...
	$('.sqip .tanbiaodan .modifymemberlayer .memberlayer1').animate({left:"0%"},100);
	$('.sqip .tanbiaodan .modifymemberlayer .memberlayer2').animate({left:"100%"},100);
...
$("#sendcertpack").click(function(){
	...
	$.ajax({
		...
		beforeSend: function() {
			$(".sendcertpacklayer .tanbiaodan .modifymemberlayer .memberlayer1 #checkbywewechat .loginewm").html('<img src="images/erweima.jpg">');
		},
		success:function(data){
			$(".sendcertpacklayer .tanbiaodan .modifymemberlayer .memberlayer1 #checkbywewechat .loginewm").html(data);
			$(".sendcertpacklayer").fadeIn();
		}
	})

	$('.sendcertpacklayer').addClass('showlayer');
	$('.checkbywewechat .loginewm .logintips').remove();
	$('.sendcertpacklayer .tanbiaodan .modifymemberlayer').removeClass('wechatheight1');
	$('.sendcertpacklayer .tanbiaodan .modifymemberlayer').addClass('wechatheight');
	$('.sendcertpacklayer .tanbiaodan .modifymemberlayer .memberlayer1').animate({left:"0%"},100);
	$('.sendcertpacklayer .tanbiaodan .modifymemberlayer .memberlayer2').animate({left:"100%"},100);
	$('.sendcertpacklayer .tanbiaodan h2').html('账户安全验证');
	$('.sendcertpacklayer .tanbiaodan .modifymemberlayer .memberlayer1 #checkmembertype input:radio[name="checkmembertype"]').prop('checked', false);
	$('.sendcertpacklayer .tanbiaodan .modifymemberlayer .memberlayer1 #checkmembertype #checkmembertype2').prop('checked', true);
	$('.sendcertpacklayer .tanbiaodan .modifymemberlayer .memberlayer1 #checkbymobile').hide();
	$('.sendcertpacklayer .tanbiaodan .modifymemberlayer .memberlayer1 #checkbywewechat').fadeIn();
	$('.sendcertpacklayer .tanbiaodan .modifymemberlayer .memberlayer1 .wvercode').val('');
	$('.sendcertpacklayer .modifymemberlayer .memberlayer1 #checkbywewechat .wenzsc').html('请使用微信扫码安全验证');
	$("#content_1").mCustomScrollbar("destroy");
	$('#getcheckcode').html('<a href="javascript:;">重新获取</a>');
	$('#getcheckcode').removeClass('yanzhengbtnactive');
	time = 180;
	$('#selectcustomer').attr('data-value','0');
	$('.sendcertpackname .select .select_text').html('请选择客户');
	$('.sendcertpackname .select .select_ul li').removeClass('cur');
	$('.channelsinputnum').val('');
	$('.channelsczlist').html('<li class="zuo"><span>充值时间</span><P>--</P></li><li class="zuo"><span>充值金额</span><P>--</P></li>');
	$('.channelsinputnum').attr('placeholder','至多可赠送客户0张证书');
	setsafecheckewm();
})
