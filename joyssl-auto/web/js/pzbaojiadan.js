...
$('#addquotationpro').live('click',function(){
...
$('.closeconfigorderpro').live('click',function(){
	$('.config_orderpro').removeClass('show');
})

// $('.pz_fits p a').live('click',function(){
...
$('.pz_type p a').live('click',function(){
	$(this).addClass('cur').siblings('a').removeClass('cur');
...
$('.pz_edition p a').live('click',function(){
	$(this).addClass('cur').siblings('a').removeClass('cur');
	var pztype=$('.pz_type p .cur').attr('datavalue');
...
$('.pz_signtype p a').live('click',function(){
	$(this).addClass('cur').siblings('a').removeClass('cur');
	var pztype=$('.pz_type p .cur').attr('datavalue');
	var pzedition=$('.pz_edition p .cur').attr('datavalue');
...
$('.pz_brands p a').live('click',function(){
	$(this).addClass('cur').siblings('a').removeClass('cur');
	var pztype=$('.pz_type p .cur').attr('datavalue');
	var pzedition=$('.pz_edition p .cur').attr('datavalue');
	var pzsigntype=$('.pz_signtype p .cur').attr('datavalue');
...
$('.pz_algorithm p a').live('click',function(){
	$(this).addClass('cur').siblings('a').removeClass('cur');
	var pztype=$('.pz_type p .cur').attr('datavalue');
	var pzedition=$('.pz_edition p .cur').attr('datavalue');
	var pzsigntype=$('.pz_signtype p .cur').attr('datavalue');
...
$('.pz_safelevel p a').live('click',function(){
	$(this).addClass('cur').siblings('a').removeClass('cur');
	var pztype=$('.pz_type p .cur').attr('datavalue');
	var pzedition=$('.pz_edition p .cur').attr('datavalue');
	var pzsigntype=$('.pz_signtype p .cur').attr('datavalue');
...
$('.pzbuycerttimes .shang #remove').live('click', function() {
...
$('.pzbuycerttimes .shang #add').live('click', function() {
	var _this = $(this).parent();
	var pzbuynum=parseFloat(_this.find('input').val()) + parseFloat(1);
...
$('.buyordernumber .shang #remove').live('click', function() {
	var _this = $(this).parent();
...
$('.buyordernumber .shang #add').live('click', function() {
	var _this = $(this).parent();
	var pzordernumber=parseFloat(_this.find('input').val()) + parseFloat(1);
...
$('#pzsingledomainnum .shang #remove').live('click', function() {
	var pztype=$('.pz_type p .cur').attr('datavalue');
	var pzedition=$('.pz_edition p .cur').attr('datavalue');
	var pzsigntype=$('.pz_signtype p .cur').attr('datavalue');
	var pzbrands=$('.pz_brands p .cur').attr('datavalue');
...
$('#pzsingledomainnum .shang #add').live('click', function() {
	var pztype=$('.pz_type p .cur').attr('datavalue');
	var pzedition=$('.pz_edition p .cur').attr('datavalue');
	var pzsigntype=$('.pz_signtype p .cur').attr('datavalue');
	var pzbrands=$('.pz_brands p .cur').attr('datavalue');
...
$('#pzsingledomainnum input').live('change', function() {
	var pztype=$('.pz_type p .cur').attr('datavalue');
	var pzedition=$('.pz_edition p .cur').attr('datavalue');
	var pzsigntype=$('.pz_signtype p .cur').attr('datavalue');
	var pzbrands=$('.pz_brands p .cur').attr('datavalue');
...
$('#pzmultidomainnum .shang #remove').live('click', function() {
	var pztype=$('.pz_type p .cur').attr('datavalue');
	var pzedition=$('.pz_edition p .cur').attr('datavalue');
	var pzsigntype=$('.pz_signtype p .cur').attr('datavalue');
	var pzbrands=$('.pz_brands p .cur').attr('datavalue');
...
$('#pzmultidomainnum .shang #add').live('click', function() {
	var pztype=$('.pz_type p .cur').attr('datavalue');
	var pzedition=$('.pz_edition p .cur').attr('datavalue');
	var pzsigntype=$('.pz_signtype p .cur').attr('datavalue');
	var pzbrands=$('.pz_brands p .cur').attr('datavalue');
...
$('#pzmultidomainnum input').live('change', function() {
	var pztype=$('.pz_type p .cur').attr('datavalue');
	var pzedition=$('.pz_edition p .cur').attr('datavalue');
	var pzsigntype=$('.pz_signtype p .cur').attr('datavalue');
	var pzbrands=$('.pz_brands p .cur').attr('datavalue');
...
$('#confirm_configpro').live('click',function(){
...
$('.editquatationpro').live('click',function(){
...
$('.delquatationpro').live('click',function(){
	var nowliindex=$(this).closest('li').index();
			...
			success:function(data){
				...
				if(data=="1"){
					...
					$.ajax({
						...
						success:function(data){
							$(".tzxboxs .tanbiaodan .modifymemberlayer .memberlayer1 #checkbywewechat .loginewm").html(data);
							setTimeout('tsetsafecheckewm()', 2000);
						}
					})
				}else{
					setTimeout('tsetsafecheckewm()', 2000);
...
$('#confirmdeleteorderpro').live('click',function(){
...
$('.generate_quotation').live('click',function(){
...
$('.generate_contract').live('click',function(){
	var companyname=$('#company_name').val();
	if(!dyfrom_min(companyname,8)){
		tips="单位名称不能少于4个汉字";
		$('#alert1 .sy-content').html(tips);
...
$('.disc_price').live('change',function(){
	const $input = $(this);
...
$('.tanbiaodan .pd30 form #checkmembertype label input').live('click',function(){
...
$('#getcheckcode13 a').live('click',function(){
	 		var action="sendcode";
	 		var url="public.html";
	 		$.ajax({
	 			type:"POST",
